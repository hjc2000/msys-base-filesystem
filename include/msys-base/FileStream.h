...
namespace msys_base
{
	...
	public:
		...
		/// @return
		///
		static std::shared_ptr<msys_base::FileStream> OpenOrCreate(base::Path const &path);
		...
		///
		static std::shared_ptr<msys_base::FileStream> CreateNewAnyway(base::Path const &path);
		...
		///
		static std::shared_ptr<msys_base::FileStream> OpenExisting(base::Path const &path);
		...
		///
		static std::shared_ptr<msys_base::FileStream> OpenReadOnly(base::Path const &path);
